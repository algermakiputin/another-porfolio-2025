          ...
          <CardContent className="card-content">
            ...
            {project?.platform === "web" ? (
              <ul className="project-info-list">
                <li>
                  <Typography variant="body2" className="meta-info">
                    <WarehouseIcon fontSize="small" sx={{ mr: 1 }} /> Industry:{" "}
                    {project?.meta?.industry}
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2" className="meta-info">
                    <Groups3Icon fontSize="small" sx={{ mr: 1 }} />
              ...
              <ul className="project-info-list">
                <li>
                  <Typography variant="body2" className="meta-info">
                    <AndroidIcon fontSize="small" sx={{ mr: 1 }} /> Platform:{" "}
                    {project?.meta?.platform}
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2" className="meta-info">
                    <CategoryIcon fontSize="small" sx={{ mr: 1 }} /> Category:{" "}
                    {project?.meta?.category}
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2" className="meta-info">
                    <PeopleIcon fontSize="small" sx={{ mr: 1 }} /> Target
                    Audience: {project?.meta?.targetAudience}
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2" className="meta-info">
                    <LanguageIcon fontSize="small" sx={{ mr: 1 }} /> Language
                    Supported: {project?.meta?.language}
                  </Typography>
                </li>
                {project?.meta?.linkLabel && (
                  <li>
            ...
            {project?.results?.map((result: any) => (
              <Grid size={{ lg: 3, md: 6, sm: 6, xs: 12 }}>
                <div className="metric">
                  ...
                  <Typography className="data" sx={{ mb: 1 }}>
                    {result?.metric} <small className="unit">Up</small>
                  </Typography>
