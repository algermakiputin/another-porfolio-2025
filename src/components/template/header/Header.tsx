import { Box, Collapse, Divider, IconButton, useTheme, Typography } from "@mui/material";
            ...
            <div className="header" style={{ backgroundColor: getBackgroundColor() }}>
                <Box sx={{ pl: 4, pr: 4 }}>
                    <div className="top-header-wrapper">
                        ...
                        <Typography
                            sx={{ color: '#fff', mt: 2, mb: 0.25, fontSize: '1.5em', fontWeight: 'bold' }}
                            variant="h1"
                ...
                <Collapse in={collapse}>
                    <Box sx={{ pl: 4, pr: 4 }}>
                        {/* Role */}
                        <Typography sx={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.75rem', fontWeight: 500, letterSpacing: '0.06em', textTransform: 'uppercase', mb: 2 }}>
                            Full Stack Engineer
                        </Typography>
                        ...
                        <img
                            ...
                            width={110}
                            alt="profile"
                            style={{ borderRadius: '50%', marginBottom: 14, border: '2px solid rgba(14,164,122,0.35)' }}
                        />

                        {/* Tagline */}
                        <Typography sx={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.8rem', lineHeight: 1.6, mb: 0.75 }} variant="body2">
                            8+ years building web, mobile, and AI-powered software for retail, e-commerce, and banking.
                        </Typography>

                        {/* Availability badge */}
                        <Box sx={{ display: 'inline-flex', alignItems: 'center', gap: 0.6, mt: 0.5, mb: 0.5 }}>
                            <Box className="availability-dot" />
                            <Typography sx={{ color: '#0bcf97', fontSize: '0.72rem', fontWeight: 600 }}>
                    ...
                    <Box sx={{ pl: 4, pr: 4 }}>
                        <Divider sx={{ mt: 3, borderColor: 'rgba(255,255,255,0.08)', opacity: 0.5 }} />
